...
size_t StrLen(const CharType * const str) {
...
template <>
size_t StrLen(const char * const str) { return ::strlen(str); }

template <>
size_t StrLen(const unsigned char * const str) { return ::strlen((const char *)str); }
